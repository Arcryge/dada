...
public final class item_002dadd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t$(function(){\r\n");
      out.write("\t\t//创建富文本编辑器\r\n");
      out.write("\t\t//itemAddEditor = DADA.createEditor(\"#itemAddForm [name=desc]\");\r\n");
      out.write("\t\titemAddEditor = KindEditor.create(\"#itemAddForm [name=desc]\",TT.kingEditorParams);\r\n");
      out.write("\t\t//初始化类目选择和图片上传器\r\n");
      out.write("\t\tDADA.init({fun:function(node){\r\n");
      out.write("\t\t\t//根据商品的分类id取商品 的规格模板，生成规格信息。\r\n");
      out.write("\t\t\tDADA.changeItemParam(node, \"itemAddForm\");\r\n");
      out.write("\t\t}});\r\n");
      out.write("\t});\r\n");
      out.write("\t//提交表单\r\n");
      ...
      out.write("\t\t\t\t//把项的内容取出来，把值的内容取出来\r\n");
      out.write("\t\t\t\t//然后把键值对放到ps数组里，拼接成一个json对象，一个group对应一个ps数组\r\n");
      out.write("\t\t\t\tps.push({\r\n");
      out.write("\t\t\t\t\t\"k\" : $.trim(tr.find(\"td\").eq(0).find(\"span\").text()),\r\n");
      out.write("\t\t\t\t\t\"v\" : $.trim(tr.find(\"input\").val())\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t//把组和组的项的信息放到paramJson数组里\r\n");
      ...
      out.write("\t\t//把此字符串写入到hidden域里，提交时随表单内容一起提交。\r\n");
