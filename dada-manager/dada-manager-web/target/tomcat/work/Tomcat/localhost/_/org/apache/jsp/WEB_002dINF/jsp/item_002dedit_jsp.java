 ...
 * Generated at: 2019-06-09 09:07:56 UTC
...
public final class item_002dedit_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t$(function(){\r\n");
      out.write("\t\t//实例化编辑器\r\n");
      out.write("\t\titemEditEditor = DADA.createEditor(\"#itemeEditForm [name=desc]\");\r\n");
      out.write("\t});\r\n");
      out.write("\t\r\n");
      out.write("\tfunction timeParse(timeStamp){\r\n");
      out.write("\t    let date = new Date(timeStamp);\r\n");
      out.write("\t    console.log(date.toString());\r\n");
      out.write("\t    let time = date.getFullYear().toString() + '-' + ((date.getMonth()+1)%13).toString() + \r\n");
      out.write("\t    \t'-' + date.getDate().toString() + ' ' + date.getHours().toString() + ':' + \r\n");
      out.write("\t    \t(date.getMinutes() > 9 ? date.getMinutes().toString() : '0' + date.getMinutes().toString() ) +\r\n");
      out.write("\t    \t':' + date.getSeconds().toString();\r\n");
      out.write("\t    return time;\r\n");
      out.write("\t  }\r\n");
      out.write("\t\r\n");
      out.write("\t//提交表单\r\n");
      out.write("\tfunction submitForm(){\r\n");
      out.write("\t\t/* var text = $(\"#created\").val();\r\n");
      out.write("\t\tvar text1 = timeParse(Number(text));\r\n");
      out.write("\t\t//alert(text1);\r\n");
      out.write("\t\t$(\"#created\").val(text1);\r\n");
      out.write("\t\tlet t = $(\"#created\").val();\r\n");
      out.write("\t\tconsole.log('当前的时间:',t); */\r\n");
      out.write("\t\t//有效性验证\r\n");
      ...
      out.write("/* \t\t$.post(\"/item/update/\"+$(\"#id\").val(),$(\"#itemeEditForm\").serialize(), function(data){\r\n");
      ...
      out.write("\t\t $.ajax({\r\n");
      out.write("\t        type: \"post\",\r\n");
      out.write("\t        url: \"/item/update/\"+$(\"#id\").val(),\r\n");
