 ...
 * Generated at: 2019-05-30 16:15:06 UTC
...
public final class item_002dlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("            <th data-options=\"field:'price',width:70,align:'right',formatter:DADA.formatPrice\">价格</th>\r\n");
      out.write("            <th data-options=\"field:'num',width:70,align:'right'\">库存数量</th>\r\n");
      out.write("            <th data-options=\"field:'barcode',width:100\">条形码</th>\r\n");
      out.write("            <th data-options=\"field:'status',width:60,align:'center',formatter:DADA.formatItemStatus\">状态</th>\r\n");
      out.write("            <th data-options=\"field:'created',width:130,align:'center',formatter:DADA.formatDateTime\">创建日期</th>\r\n");
      out.write("            <th data-options=\"field:'updated',width:130,align:'center',formatter:DADA.formatDateTime\">更新日期</th>\r\n");
      out.write("        </tr>\r\n");
      out.write("    </thead>\r\n");
      out.write("</table>\r\n");
      ...
      out.write("        \t\t\tdata.priceView = DADA.formatPrice(data.price);\r\n");
      ...
      out.write("        \t\t\t\r\n");
      out.write("        \t\t\t//加载商品规格\r\n");
      out.write("        \t\t\t$.getJSON('/item/query/item/param/'+data.id,function(_data){\r\n");
      ...
      out.write("        \t\t\t\t\tDADA.changeItemParam(node, \"itemeEditForm\");\r\n");
      out.write("        \t\t\t\t}\r\n");
      out.write("        \t\t\t});\r\n");
      out.write("        \t\t}\r\n");
      ...
      out.write("                \t$.post(\"/item/delete/\"+ids,params, function(data){\r\n");
