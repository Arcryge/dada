...
<body id="mainframe">
	...
	<div class="w w1 header clearfix">
		<div id="logo">
			<a href="/"><img src="/images/dada.png" alt="达达商城"></a>
		</div>
	</div>
	...
	<form id="orderForm" class="hide" action="/order/create.html"
		...
		<input type="hidden" name="orderShipping.receiverName" value="林俊杰" />
		<input type="hidden" name="orderShipping.receiverMobile"
			value="17806236033" /> <input type="hidden"
			name="orderShipping.receiverState" value="山东" /> <input type="hidden"
			name="orderShipping.receiverCity" value="青岛" /> <input type="hidden"
			name="orderShipping.receiverDistrict" value="黄岛区嘉陵江东路777号" /> <input
			type="hidden" name="orderShipping.receiverAddress" value="青岛理工大学" />
	</form>
					...
					<div class="checkout-steps">
						...
						<div class="step-cont">
							<div class="consignee-list" id="consignee-list1">
								<a href="#none" id="prev" class="prev arrow-btns"></a> <a
									href="#none" id="next" class="next arrow-btns"></a>
									...
									<ul class="ui-switchable-panel-main" id="consignee-list">
										...
										<li class="ui-switchable-panel" id="consignee_index_137617472"
											...
											<div class="consignee-item item-selected"
												...
												<div class="user-name">
													<div class="fl">
														<strong limit="4">林俊杰</strong>&nbsp;&nbsp;收
													</div>
													<div class="fr">178****6033</div>
													<div class="clr"></div>
												</div>
												<div class="mt10" limit="15">山东 青岛 黄岛区 嘉陵江东路777号</div>
												<div class="adr-m" limit="30">青岛理工大学</div>
									...
									<div class="shopping-lists" id="shopping-lists">
										<div class="shopping-list ABTest">
											<div class="goods-list">
												<!--配送方式-->
												<h4 class="vendor_name_h" id="0">商家：达达商城</h4>
													...
													<div class="mode-tab-nav">
														<ul>
															<li class="mode-tab-item " id="jd_shipment_item"
																onclick=""><span id="jdShip-span-tip" class="m-txt">达达快递<i
																	class='qmark-icon qmark-tip'
																	data-tips='由达达公司负责配送，速度很快，还接受上门刷卡付款服务'></i></span><b></b></li>
														</ul>
													</div>
												</div>
											</div>
						...
						<div class="step-content">
							<div id="part-inv" class="invoice-cont">
								<span class="mr10"> 普通发票（电子） &nbsp; </span><span class="mr10">
									...
									class="ftx-05 invoice-edit" onclick="">修改</a>
							</div>
						</div>
							...
							<div class="sticky-wrap">
								<div class="inner">
									...
									<div style="display: none" id="factoryShipCodShowDivBottom"
										class="dispatching">部分商品货到付款方式：先由达达配送“提货单”并收款，然后厂商发货。</div>
								</div>
