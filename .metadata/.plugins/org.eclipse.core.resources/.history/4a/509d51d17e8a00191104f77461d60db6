...
<div class="w w1 header clearfix">
    <div id="logo"><a href="/"><img src="/images/dada.png" alt="达达商城"></a></div>
</div>
...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverMobile" value="17806236033"/>
		<input type="hidden" name="orderShipping.receiverState" value="山东"/>
		<input type="hidden" name="orderShipping.receiverCity" value="青岛"/>
		<input type="hidden" name="orderShipping.receiverDistrict" value="黄岛区嘉陵江东路777号"/>
		<input type="hidden" name="orderShipping.receiverAddress" value="青岛理工大学"/>
</form>
		...
		<div class="mode-tab-nav">
			<ul>
				<li class="mode-tab-item " id="jd_shipment_item"
					onclick=""><span
					id="jdShip-span-tip" class="m-txt">达达快递<i
						class='qmark-icon qmark-tip'
    ...
    <div class="ui-ceilinglamp checkout-buttons">
      ...
      <div class="sticky-wrap">
          ...
          <div style="display:none" id="factoryShipCodShowDivBottom" class="dispatching">
            部分商品货到付款方式：先由达达配送“提货单”并收款，然后厂商发货。
          </div>
        </div>
