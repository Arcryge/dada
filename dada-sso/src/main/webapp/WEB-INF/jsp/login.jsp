...
<!-- <div class="w">
    <div id="logo">
    	<a href="http://localhost:8082" clstag="passport|keycount|login|01">
    		<img src="/images/dada.png" alt="达达" width="170" height="60"/>
    	</a><b></b>
   	</div>
</div> -->
<form id="formlogin" method="post" onsubmit="return false;">
    <div class=" w1" id="entry">
        <div class="mc " id="bgDiv">
            <div id="entry-bg" clstag="passport|keycount|login|02" style="width: 511px; height: 455px; position: absolute; left: 44px; top: 44px; background: url(/images/dada.png) 0px 0px no-repeat;">
			</div>
            <div class="form ">
